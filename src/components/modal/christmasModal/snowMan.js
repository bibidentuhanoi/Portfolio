...
export default function SnowMan() {
  return (
    <svg id="svg_snowman" x="0px" y="0px" viewBox="-30 55 250 248">
      <g id="snowman">
        <path
          className="snowman_body"
          fill="white"
          d="M20.302,221.826c-6.899,83.792,106.271,110.246,149.672,47.643
        ...
        <path
          className="scarf"
          fill="#EF3C3C"
          d="M62.978,157.992c-5.486,2.424-8.756,6.673-7.191,13.735
        ...
        <path
          ...
          fill="#EF3C3C"
          d="M88.509,177.525c-18.559,6.252-29.452,33.552-28.112,51.221
        ...
        <path
          ...
          fill="white"
          d="M145.783,120.573c-2.77-5.274-6.473-9.863-11.039-13.207
        ...
        <g id="hat">
          <path
            ...
            fill="#EF3C3C"
            d="M45.071,104.135l6.829,12.61c34.1-33.933,65.013-19.442,65.013-19.442l-1.961-14.935
          ...
          <path
            className="hat-top"
            fill="#5B4831"
            d="M112.882,63.362c0,0-8.829-9.698-36.575-5.148C37.661,64.555,35.338,85.67,35.338,85.67l9.733,18.465
          ...
          <path
            ...
            fill="#5B4831"
            d="M53.534,129.075c0.036-0.068,25.632-34.575,72.603-27.137c2.978,1.543,5.882,3.363,8.606,5.366
        ...
        <path
          className="nose"
          fill="#EF3C3C"
          d="M104.781,143.55c-1.708,18.2,27.856,10.402,38.028,9.453c7.191-0.669,13.764-1.581,20.483-2.495
        ...
        <path
          className="mouth-1"
          fill="#5B4831"
          d="M84.079,158.94c-0.91,0.492-2.034,0.106-2.506-0.842c-0.439-0.913,0.036-1.932,0.98-2.321
        ...
        <path
          className="mouth-2"
          fill="#5B4831"
          d="M88.292,164.63c-0.691,0.739-2.034,0.881-2.651-0.036c-0.688-0.878-0.582-2.07,0.292-2.633
        ...
        <path
          className="mouth-3"
          fill="#5B4831"
          d="M94.43,168.426c-0.472,0.88-1.635,1.263-2.579,0.81c-1.017-0.353-1.236-1.652-0.654-2.462
        ...
        <path
          className="mouth-4"
          fill="#5B4831"
          d="M101.222,170.849c-0.256,0.948-1.309,1.511-2.326,1.266c-1.017-0.283-1.559-1.231-1.163-2.215
        ...
        <path
          className="mouth-5"
          fill="#5B4831"
          d="M108.376,172.151c-0.109,0.984-1.053,1.72-2.107,1.578c-1.053-0.106-1.741-0.983-1.525-2.002
        ...
        <path
          className="mouth-6"
          fill="#5B4831"
          d="M115.64,172.36c0.036,1.019-0.761,1.864-1.814,1.935c-1.053,0.103-1.891-0.739-1.817-1.793
        ...
        <path
          className="mouth-7"
          fill="#5B4831"
          d="M122.831,171.412c0.256,0.948-0.399,1.967-1.452,2.212c-1.017,0.318-1.964-0.418-2.107-1.437
        ...
        <path
          className="mouth-8"
          fill="#5B4831"
          d="M129.587,168.953c0.508,0.878,0.146,2.002-0.837,2.494c-0.907,0.598-2.034,0.035-2.393-0.913
        ...
        <path
          className="mouth-9"
          fill="#5B4831"
          d="M135.252,164.665c0.798,0.669,0.834,1.864,0.073,2.671c-0.761,0.81-1.888,0.775-2.542-0.103
        ...
        <path
          className="mouth-10"
          fill="#5B4831"
          d="M138.994,158.763c0.944,0.318,1.416,1.408,1.017,2.426c-0.399,1.019-1.452,1.369-2.323,0.842
        ...
        <path
          className="eye_left"
          fill="#5B4831"
          d="M94.939,125.986c4.396-2.494,0.581-8.746-3.775-6.535
		C86.585,121.769,90.037,128.76,94.939,125.986z"
        />

        <path
          className="eye_right"
          d="M127.663,123.63c4.393-2.456,0.582-8.746-3.778-6.497
        ...
        <path
          ...
          fill="#610101"
          d="M134.053,227.38c13.039-2.391,12.205-20.626-2.323-18.904
        ...
        <path
          ...
          fill="#610101"
          d="M130.022,262.687c11.696,1.157,17.289-16.336,5.267-19.219
